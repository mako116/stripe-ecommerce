...
import { addToCart} from "../redux/renderSlice"
  ...
  return (
    <>
      ...
      <div className='w-2/5 relative'>
        ...
        alt="ProductImg" className='w-full h-[550px] object-cover' />
      ...
      <div>
        ...
        <p
         className='line-through text-gray-500'>${details.oldPrice}
         </p>
        <p
         className='font-semibold'>${details.price}
        </p>
        </div>
      </div>
      ...
      <button className='bg-black
       text-white py-3 px-6 active:bg-gray-800' 
       onClick={()=>
        dispatch(addToCart(
        {
          _id: details._id,
       ...
       )) & toast.success(`${details.title}cis added`)}>add to cart </button>
      </div>
