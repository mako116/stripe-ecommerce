...
import { decreamentQuantity, deleteItem, increamentQuantity, resetCart } from '../redux/renderSlice'
  ...
  return (
    <div className='w-2/3 pr-10'>
      ...
      <div className=''>
      {
       ...
       duration-300 active:bg-black'>-</span>
         {item.quantity}
        <span 
        onClick={()=>
     ...
     <button onClick={()=>dispatch(resetCart()) & toast.error("your cart is Empty")}
      className='bg-red-500 text-white ml-7 mt-8 py-1 px-6 hover:bg-red-800 
     duration-300'>Reset All Item</button>
     <Link to="/">
     <button className='mt-8 ml-7 flex items-center gap-1
