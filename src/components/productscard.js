 ...
 const Productscard = ({product}) => {
  ...
  const rootId = idString(_id)
   ...
   return (
    ...
    <img src={product.image} alt="cardImg" className='w-full h-full object-cover group-hover:scale-110 duration-500'/>
     </div>
     <div className='w-full border-[1px] px-2 py-4'>
      ...
      <div className='flex justify-end gap-2 relative overflow-hidden w-28 text-sm'>
       ...
       }))& toast.success(`${product.title}is added`)} className='absolute z-20 w-[100px] text-gray-500 hover:text-gray-900 flex-items-center 
